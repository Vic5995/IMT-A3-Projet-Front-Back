...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IRMSoundManager_Start_m150D0E539895CD067D13641ECE59113DD5470889 (IRMSoundManager_tE7EFA7EAC867D71D1AB8F6C75A08EB32D2550936* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___patient_4 = L_2;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___patient_4), (void*)L_2);
	}
...
IL_0040:
	{
		// if(distance > 4 && irmSoundEffect.isPlaying)
		if ((!(((float)G_B3_0) > ((float)(4.0f)))))
		{
			goto IL_005f;
		}
	}
	{
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_10 = __this->___irmSoundEffect_6;
		NullCheck(L_10);
		bool L_11;
	...
	}
	{
		...
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_12 = __this->___irmSoundEffect_6;
		NullCheck(L_12);
